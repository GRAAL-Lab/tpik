...
void ActionManager::AddPriorityLevel(const std::string priorityLevelID) {
  ...
  priorityLevelIDMap_.insert(std::make_pair(
      priorityLevelID,
      std::make_shared<PriorityLevel>(PriorityLevel(priorityLevelID))));
}
...
void ActionManager::AddTaskToPriorityLevel(std::shared_ptr<Task> task,
                                           const std::string priorityLevelID) {
...
void ActionManager::AddAction(std::string actionID,
                              std::vector<std::string> priorityLevelsID) {
...
void ActionManager::SetUnifiedHierarchy(
    std::vector<std::string> unifiedHierarchy) {
  hierarchy_.clear();
...
ActionManager::GetAction(std::string actionID) throw(ExceptionWithHow) {
...
ActionManager::GetPriorityLevel(std::string priorityLevelID) {
