 ...
 * define the actions.
 * @note The order in which the priorityLevels are created defines their priority in the unified heirarhcy.
 */
class ActionManager
{
public:
	 ...
	 * @note An exception is thrown if the priority level does not exist in the unified hierarchy (Via GetPriorityLevel method).
	 ...
	 * An exception is thrown if the priority level does not exist in the unified hierarchy.
