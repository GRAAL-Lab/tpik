 ...
 * @details Implementation of the PriorityLevel Class. Starting form a vector of tpik::Task which have the same priority
 * it computes the Jacobian, internal activation function and reference by juxtaposing the related task matrices.
 * Methods to set the external Activation Function are provided. It is assumed that all the Tasks have the same behavior
 *  wrt the external activation function (hence either they are all present or none of them are present in an action).
...
public:
    ...
    */
    ...
    /*
    * @brief Method getting the PriorityLevel ID.
    ...
    */
    void Update();
    /*
    * @brief Methods setting the PriorityLevel regularization data.
    */
    auto RegularizationData() -> rml::RegularizationData& { return regularizationData_; }
    /*
    * @brief Methods getting the PriorityLevel regularization data.
    */
    ...
    */
    ...
    /*
    * @brief Method Returning the PriorityLevel Activation Function computed as follows : AactionT*Aexternal*Ai.
    ...
    */
    ...
    /*
    * @brief Method setting the PriorityLevel action transition Activation Function.
    ...
    */
    ...
    /*
    * @brief Methods setting  the last delta increment computed for the priority level.
    */
    auto DeltaY() -> Eigen::VectorXd& { return deltaY_; }
    /*
    * @brief Methods getting  the last delta increment computed for the priority level.
    */
...
private:
    ...
    */
    ...
    std::vector<std::shared_ptr<Task>> level_; // The vector containing the std::shared_ptr to tpik::Task.
    ...
    int priorityLevelSpace_; // The priority level space
};
} // namespace tpik
