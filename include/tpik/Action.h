...
/*
* @brief Action class.
* @details Implementation of the Action class. Each action is composed by an ID and a vector of std::shared_ptr to
* tpik::PriorityLevels defining the action hierarchy.
*/
